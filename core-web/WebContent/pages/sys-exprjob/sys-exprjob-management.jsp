...
function manualExecute(oid) {
	parent.bootbox.confirm(
			...
			function(result) { 
				...
				xhrSendParameter(
						'./core.sysExpressionJobManualExecuteJson.do', 
						{ 'oid' : oid }, 
						function(data) {
...
function deleteRecord(oid) {
	parent.bootbox.confirm(
			...
			function(result) { 
				...
				xhrSendParameter(
						'./core.sysExpressionJobDeleteJson.do', 
						{ 'oid' : oid }, 
						function(data) {
							if ( _qifu_success_flag != data.success ) {
								parent.toastrWarning( data.message );
...
<jsp:include page="../common-f-head.jsp"></jsp:include>
      ...
      <div class="row">     
        <div class="col-xs-6 col-md-6 col-lg-6">
        	<q:textbox name="id" value="" id="id" label="Id" placeholder="Enter Id" maxlength="20"></q:textbox>
        </div>
        <div class="col-xs-6 col-md-6 col-lg-6">
...
<q:grid gridFieldStructure="getQueryGridHeader()" 
	...
	"
	xhrUrl="./core.sysExpressionJobQueryGridJson.do" 
